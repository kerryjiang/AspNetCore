...
namespace Microsoft.AspNetCore.Routing.Matching
{
    public class HttpMethodMatcherPolicyTest
    {
        ...
        [Fact]
        public void IEndpointSelectorPolicy_AppliesToNode_EndpointWithoutMetadata_ReturnsFalse()
        {
            // Arrange
        ...
        [Fact]
        public void IEndpointSelectorPolicy_AppliesToNode_EndpointWithoutHttpMethods_ReturnsFalse()
        {
            // Arrange
            var endpoints = new[]
            {
